        ...
        <div>
            <div className={HeadCSS.center}>
                ...
                <div className={HeadCSS.choice}>
                    ...
                    <Link to="/destroy" className={HeadCSS.destruction}>
                        Уничтожение
                    </Link>
                </div>
                ...
                <label className={HeadCSS.distance}>
                    Расстояние
                    <button className={state.distanceMode === 0 ? HeadCSS.km : HeadCSS.moon} onClick={MoonToKm}>
                        в километрах
                    </button>
                    ,
                    <button className={state.distanceMode === 0 ? HeadCSS.moon : HeadCSS.km} onClick={KmToMoon}>
