...
export function Login() {
    ...
    return (
        <>
            <div className={OtherInfoStyles.choice}>
                <Link
                    to="/destroy"
                    className={OtherInfoStyles.destruction}
                >
                    Уничтожение
                </Link>
                <Link to="/" className={OtherInfoStyles.destruction}>
                    Астероиды
                </Link>
            </div>
            ...
            <div className={LoginStyles.form}>
                ...
                <div>
                    ...
                    />
                    <label>
                        Сохранить данные для их использования в
                        дальнейшем
                    </label>
                </div>
                <button
