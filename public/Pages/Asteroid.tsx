...
import { Ast } from '../Modules/Asteroid/Asteroid';
    ...
    return (
        <>
            <div className={HeadStyles.position}>
                <label className={HeadStyles.title}>
                    ARMAGGEDON V
                </label>
                ...
                <div className={HeadStyles.choice}>
                    <label className={HeadStyles.asteroids}>
                        Астероиды
                    </label>
                    <Link
                        to="/destroy"
                        className={HeadStyles.destruction}
                    >
                        Уничтожение
                    </Link>
                </div>
                ...
                <input
                    className={HeadStyles.check}
                    type="checkbox"
                    onChange={Show}
                />
                <label className={HeadStyles.danger}>
            ...
            <div className={OtherInfoStyles.position}>
                <label className={OtherInfoStyles.end}>
